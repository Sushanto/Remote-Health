...
public class TestClient
{
	...
	private static String datapath = "/home/rounak/Dropbox/Projects/RemoteHealth/Servers (Release)/server/TestData/TestClient/";
	...
	public static int handleCommand(String command) throws Exception
	{
		...
		case "get":
			...
			if (resp > 0 && logintype != null && logintype.equals("DOC")) {
				con.receiveFile(datapath + "got_" + tokens[1]);
			}
			return resp;
		case "put":
